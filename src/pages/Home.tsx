    ...
    <section className="relative min-h-[78vh] overflow-hidden" style={{backgroundImage:`url(${hero})`,backgroundSize:'cover',backgroundPosition:'center'}}>
      ...
      <div className="relative mx-auto flex min-h-[78vh] max-w-7xl items-center px-4 py-24 md:px-6">
        <div className="max-w-2xl text-white">
          ...
          <div className="mt-8 flex flex-wrap gap-3"><Link to="/products" className="btn-primary bg-white !text-[#7f1d1d]">Shop Products <ArrowRight className="ml-2 inline" size={17}/></Link><Link to="/about" className="rounded-xl border border-white/40 bg-white/10 px-5 py-3 font-bold backdrop-blur">About Moshlai</Link></div>
        </div>
      </div>
    </section>
